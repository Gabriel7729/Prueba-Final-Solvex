...
namespace GenericApi.Model.Migrations
{
    ...
    [Migration("20210815222523_InitialDatabase")]
            ...
            modelBuilder.Entity("GenericApi.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 15, 22, 25, 22, 171, DateTimeKind.Unspecified).AddTicks(6651), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Dob = new DateTime(2021, 8, 15, 18, 25, 22, 171, DateTimeKind.Local).AddTicks(7309),
                            DocumentType = 0,
